...
// Source: github.com/marcosavieira/simpleBank/db/sqlc (interfaces: Store)
...
func (m *MockStore) TransferTx(arg0 context.Context, arg1 db.TransferTxParans) (db.TransferTxResult, error) {
	m.ctrl.T.Helper()
